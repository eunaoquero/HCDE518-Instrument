...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'HCDE518webVR.data';
    var REMOTE_PACKAGE_BASE = 'HCDE518webVR.data';
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 3718909;
      var PACKAGE_UUID = 'cdde7a30-6aa8-4697-98bd-4b7fef866da6';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    new DataRequest(22, 219219, 0, 0).open('GET', '/data.unity3d');
    new DataRequest(219219, 219627, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(219627, 2194591, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(2194591, 3691283, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(3691283, 3718909, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
    ...
    function processPackageData(arrayBuffer) {
      ...
      DataRequest.prototype.byteArray = byteArray;
          ...
          Module['removeRunDependency']('datafile_HCDE518webVR.data');

    };
    Module['addRunDependency']('datafile_HCDE518webVR.data');
